    ...
    <div className='bg-gray-100 pb-10 h-screen w-screen'>
        ...
        <div className="container mx-auto md:pt-10 grid">
            <div className="wrapper w-10/12 md:w-1/2 py-10 mx-auto p-5 bg-white rounded-xl mt-14 shadow-xl my-auto">
                ...
                <Input placeholder='Masukan kode OTP' font='text-[#016b3f] text-sm md:text-lg text-[#016b3f]' tittle='Kode OTP' width='w-11/12 mx-auto mt-10' />
                <Button text='Verifikasi OTP' width='w-3/4 md:w-1/4 mx-auto my-10 hover:opacity-80' />
            </div>
