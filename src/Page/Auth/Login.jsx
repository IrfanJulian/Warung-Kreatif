    ...
    <div className='bg-gray-100 pb-10 h-screen'>
        ...
        <div className="container mx-auto grid">
            <div className="wrapper w-10/12 md:w-1/2 py-10 mx-auto p-5 bg-white rounded-xl mt-14 shadow-xl my-auto">
                ...
                <Input placeholder='Masukan email' font='text-[#016b3f] text-sm md:text-lg text-[#016b3f]' tittle='Username atau Email' width='w-11/12 mx-auto mt-10' />
                <Password placeholder='Masukan Password' tittle='password' width='w-11/12 mx-auto my-5' show={show} onClick={()=>show === true ? setShow(false) : setShow(true)} />
                ...
                <Button text='Masuk' width='w-3/4 md:w-1/4 mx-auto my-10 hover:opacity-80' />
